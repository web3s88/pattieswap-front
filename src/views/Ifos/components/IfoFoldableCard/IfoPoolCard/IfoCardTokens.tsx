...
const IfoCardTokens: React.FC<IfoCardTokensProps> = ({
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    t(
      'Sorry, you didn’t contribute enough PATC to meet the minimum threshold. You didn’t buy anything in this sale, but you can still reclaim your PATC.',
    ),
    { placement: 'bottom' },
  )
        ...
        <Message my="24px" p="8px" variant="danger">
          <Box>
            <MessageText as="span" color="failure">
              {t('You don’t have any average PATC balance available to commit in the IFO PATC pool.')}
            </MessageText>{' '}
      ...
      return userPoolCharacteristics.amountTokenCommittedInLP.isEqualTo(0) ? (
        <Flex flexDirection="column" alignItems="center">
          ...
          <Text textAlign="center" fontSize="14px">
            {t('To participate in the next IFO, stake some PATC in the IFO PATC pool!')}
          </Text>

  ...
  return (
    <CardBody>
      ...
      <Heading as="h4" color="secondary" mb="16px">
        {t('Stake PATC in IFO pool')}
      </Heading>
      <Box>
        <Text color="textSubtle" small>
          {t(
            'The maximum amount of PATC user can commit to all the sales combined, is equal to the average PATC balance in the IFO PATC pool prior to the IFO. Stake more PATC to increase the maximum PATC you can commit to the sale. Missed this IFO? You can keep staking in the IFO PATC Pool to join the next IFO sale.',
          )}
        </Text>
      ...
      {hasProfile && (
        <SmallStakePoolCard borderRadius="default" p="16px">
          <FlexGap justifyContent="space-between" alignItems="center" flexWrap="wrap" gap="16px">
            ...
            <Button onClick={onPresentStake}>{t('Stake')} PATC</Button>
          </FlexGap>
        </SmallStakePoolCard>
      )}
    </CardBody>
...
const Step2 = ({ hasProfile, isLive, isCommitted }: { hasProfile: boolean; isLive: boolean; isCommitted: boolean }) => {
  ...
  return (
    <CardBody>
      ...
      <Text color="textSubtle" small>
        {t('When the IFO sales are live, you can “commit” your PATC to buy the tokens being sold.')} <br />
      ...
      case 3:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t(
                'After the IFO sales finish, you can claim any IFO tokens that you bought, and any unspent PATC tokens will be returned to your wallet.',
              )}
            </Text>
          </CardBody>
        )

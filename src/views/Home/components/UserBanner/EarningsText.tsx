...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and PATC pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and PATC pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from PATC pool', data)
  }

...
const stepsConfigBuilder = ({ t, userInfos, eventInfos, userStatus, account, theme, cakeBalance }: EventStepsType) => {
  ...
  return [
    ...
    },
    {
      ...
      title: t('Hold PATC'),
      bodyText: [t('Each NFT costs PATC to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
            href="https://swap.pattieswap.finance/swap?outputCurrency=0x46777d443A2e41091fCC5e305D7caf64BBa455Aa"
            target="_blank"
            width="100%"
          >
            {t('Buy PATC')}
